...
<head>
    ...
    <style>
        ...
        /* Main Content Adjustment - UPDATED to match ParkingArea.php */
        .main-container {
            margin-left: 250px;
            margin-top: 120px;
            padding: 40px;
        ...
        .go-parking-btn:hover {
            background-color: #4e1692;
...
<body>
    ...
    <div class="container main-container" id="mainContainer">
        <h1 class="mb-4"><i class="fas fa-parking"></i> Parking Management</h1>
