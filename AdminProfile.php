...
<head>
    ...
    <style>
        ...
        .profile-picture {
            width: 200px;
            height: 200px;
            background: linear-gradient(135deg, #7405f1ff, #3f1174ff);
            border-radius: 50%;
            margin: 0 auto 20px;
            display: flex;
            align-items: center;
        ...
        .info-item {
            ...
            background: #f9f7ff;
            border-radius: 6px;
            border-left: 3px solid #7405f1ff;
        }
        ...
        .form-section {
            ...
            border-radius: 8px;
            margin-bottom: 20px;
            border-left: 4px solid #7405f1ff;
        }
        ...
        .password-input:focus {
            outline: none;
            border-color: #7405f1ff;
            box-shadow: 0 0 0 2px rgba(116, 5, 241, 0.1);
        }
...
<body>
    ...
    <div class="container main-container" id="mainContainer">
        <h1 class="mb-4"><i class="fas fa-user-shield"></i> Admin Profile</h1>
