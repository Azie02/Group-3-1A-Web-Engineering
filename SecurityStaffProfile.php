...
// Restrict access to only logged-in security staff
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="menu">
            ...
            <li>
                <a href="VerifyVehicle.php" class="menutext">
                    <i class="fas fa-car"></i> Verify Vehicle
                </a>
            </li>
            <li>
                <a href="SecurityReport.php" class="menutext">
        ...
        <div class="profile-container">
            ...
            <div class="profile-left">
                ...
                <div style="margin-top: 20px;">
                    ...
                    <span class="status-badge status-security">Security Staff</span>
                </div>
            </div>
            ...
            <div class="profile-right">
                <h2 class="profile-title">
                    <i class="fas fa-user-shield"></i> Security Staff Profile
                </h2>
                ...
                <div class="profile-info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value"><?php echo date('Y-m-d H:i:s', $staff['LastLogin']); ?></div>
                        </div>
    ...
    <script>
        ...
        // Function to get staff initials
